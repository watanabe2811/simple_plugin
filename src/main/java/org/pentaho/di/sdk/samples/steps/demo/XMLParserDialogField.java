...
import org.pentaho.di.sdk.samples.steps.demo.DemoStepData;
 ...
 * @since 20-06-2007
 */
public class XMLParserDialogField implements Cloneable {
  private static Class<?> PKG = DemoStepData.class; // for i18n purposes, needed by Translator2!!

  public static final int RESULT_TYPE_VALUE_OF = 0;
  public static final int RESULT_TYPE_TYPE_SINGLE_NODE = 1;

  public static String PREFIX_TAG="DemoStepMetaField";
  ...
  public XMLParserDialogField( String fieldname ) {
    this.name = fieldname;
    this.xpath = "";
    this.length = -1;
  ...
  public XMLParserDialogField( Node fnode ) throws KettleValueException {
  ...
  public Object clone() {
    try {
      XMLParserDialogField retval = (XMLParserDialogField) super.clone();
